...
def roomlis(index):
    if index == 0:
        ...
        light2 = dict(typ='light', name='RGB Strip', cls=2, agent=0, agent_index='12', agent_indexG='13',
                      agent_indexB='14', ps=3)
        # windows--------------
        ...
        _agents = [0]
        _objects = [ps, ps1, ps2, ps3, ps4, ps5, ps6, ps7, ps8, window1, window2, light1, light2, tv, firestick,
                    thermostat, lcd, ir_rcv]
